...
class IntelligenceModule:
    ...
    def __init__(self, main_config: dict, event_recorder: EventRecorder | None = None,
        ...
        # NOTE: two-energy elemental-map analysis was intentionally removed from the
        # intelligence module. The task agent owns that computation now
        # (ToolSet.count_element_particles), so the map is produced in the same process
        # where it is displayed and saved to the logbook — no cross-process duplication.

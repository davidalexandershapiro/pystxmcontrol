...
meta["xrange"] = 8.0
meta["xpoints"] = 320
meta["ycenter"] = 173.582
meta["yrange"] = 8.0
meta["ypoints"] = 320
meta["energyStart"] = 2300
meta["energyStop"] = 2300
meta["energyPoints"] = 1
meta["dwell"] = 4.0
meta["spiral"] = False
meta["autofocus"] = False
meta["cmap"] = "Greys" #viridis', 'plasma', 'inferno', 'magma', 'cividis', 'Greys',
meta["daq list"] = ["default","xrf"]
meta["comment"] = "XRF Image"
print(meta)
for i in range(100):
    asyncio.run(stxm_scan(meta))
